...
func (t *Trace) ToPprofWithMetrics() (*profile.Profile, error) {
...
func (t *Trace) ToPprofFlat() (*profile.Profile, error) {
	// Extract timing metrics
	extractor := NewTimingMetricsExtractor(t)
	metrics, err := extractor.Extract()
	if err != nil {
...
func (t *Trace) ToPprofPerInvocation() (*profile.Profile, error) {
	// Extract timing metrics
	extractor := NewTimingMetricsExtractor(t)
	metrics, err := extractor.Extract()
	if err != nil {
