...
func (t *Trace) GenerateInsights() (*InsightsReport, error) {
...
func (t *Trace) detectBottlenecks(shader *ShaderMetrics, report *InsightsReport) {
...
func (t *Trace) detectOptimizations(shader *ShaderMetrics, report *InsightsReport) {
...
func (t *Trace) detectAntiPatterns(shader *ShaderMetrics, report *InsightsReport) {
...
func (t *Trace) detectOverallPatterns(metrics *ShaderMetricsReport, report *InsightsReport) {
